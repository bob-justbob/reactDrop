    ...
    return (
        <div className="sectionA">
            <div className="A-text">
                ...
                <p><strong>ONE</strong> POINT OF CONTACT PROVIDING TOP DROPSHIP PRODUCTS FROM WORLDWIDE SUPPLIERS</p>
            </div>
            <div className="A-boxes">
                <div className="box-content">
                    ...
                    <div className="box-content">
                        ...
                        <AsectionProps img={secondImg} header={200.000} texts={"Products"}/>
